...
public class ParticleRegistry {
    ...
    public static final DefaultParticleType HIGHLIGHT = FabricParticleTypes.simple();
    ...
    public static void register() {
        ...
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(Main.MODID, "highlight"), HIGHLIGHT);
    ...
    public static void registerClient() {
        ...
        ParticleFactoryRegistry.getInstance().register(HIGHLIGHT, HighlightParticle.Factory::new);
